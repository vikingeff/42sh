...
/*   Updated: 2014/02/26 16:35:16 by rda-cost         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (*list && (*list)->next && ft_special_char((*list)->next->c) && (*list)->next->c)
	{
		while (*list && (*list)->next && ft_special_char((*list)->next->c) && (*list)->next->c)
			k_right(cmd, cursor, list);
		return ;
	}
	while (*list && (*list)->next && !ft_special_char((*list)->next->c) && (*list)->next->c)
